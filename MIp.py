...
def mutual_information_p():

    counter = [["A", 0], ["C", 0], ["D", 0], ["E", 0], ["F", 0], ["G", 0], ['H', 0], ["I", 0], ["K", 0], ["L", 0],
    ...
    for loop in range(0, alignment.get_alignment_length()):  # Recorrer las columnas
        ...
        positions = alignment[:, column]  # Asigna la cadena correspondiente a la columna actual
        ...
        current_results = [column, counter[0][1], counter[1][1], counter[2][1], counter[3][1], counter[4][1], counter[5][1],
    ...
    numpy.savetxt(f'{name_1}_{name_2}_MI_matrix.csv', MImatrix1, delimiter=",", fmt='%s')  # crea un csv de la matriz
    ...
    numpy.savetxt(f'{name_1}_{name_2}_APC_matrix.csv', APCmatrix, delimiter=",", fmt='%s')  # crea un csv de la matriz
    ...
    numpy.savetxt(f'{name_1}_{name_2}_MIp_matrix.csv', MIpmatrix, delimiter=",", fmt='%s')  # crea un csv de la matriz
    ...
    numpy.savetxt(f'{name_1}_{name_2}_wMIp_matrix.csv', wMIpmatrix, delimiter=",", fmt='%s')  # crea un csv de la matriz

    print("-------------- w M I p ------------------\nDone")

    print('Processing output file')

    with open(f'{name_1}_{name_2}_MIp_detailed.csv', "a") as f:
