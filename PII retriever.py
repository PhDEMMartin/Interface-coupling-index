...
def retriever():
    ...
    print('MIp matrix length', len(mip_matrix))
    ...
    print('last pii', pii[len(pii) - 1])
    print('end', end)

    # for i in range(630960, 632150):
    #     print(mip_matrix[i])

    save = '{}wMIp_final_4.csv'.format(file[:6])
    f = open(save, "a")
            ...
            for k in range(len(pii)):
                ...
                if pii[j] != 'NA' and pii[k] != 'NA':
                    if int(mip_matrix[i][0]) == int(pii[j]) and int(mip_matrix[i][1]) == int(pii[k]):
                        ...
                        f.write(line)
                # elif pii[j] == 'NA' and pii[k] != 'NA':
                #     if int(mip_matrix[i][1]) == int(pii[k]):
                #         line = '{},{},{},{},{},{},{},{},{},{}\n'.format('NA', mip_matrix[i][1],
                #                                                         'NA', 'NA',
                #                                                         'NA', 'NA',
                #                                                         'NA', 'NA',
                #                                                         'NA', 'NA')
                #         f.write(line)
                # elif pii[j] != 'NA' and pii[k] == 'NA':
                #     if int(mip_matrix[i][0]) == int(pii[j]):
                #         line = '{},{},{},{},{},{},{},{},{},{}\n'.format(mip_matrix[i][0], 'NA',
                #                                                         'NA', 'NA',
                #                                                         'NA', 'NA',
                #                                                         'NA', 'NA',
                #                                                         'NA', 'NA')
